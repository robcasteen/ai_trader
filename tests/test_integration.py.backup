...
class TestFullTradeCycle:
    ...
    def test_complete_buy_cycle(
        self, mock_scheduler, mock_headlines, mock_symbols,
        mock_signal, mock_kraken, temp_env
    ):
    ...
    def test_multiple_symbols_cycle(
        ...
        btc_trade = next(t for t in trades if t['symbol'] == 'BTC/USD')
        eth_trade = next(t for t in trades if t['symbol'] == 'ETH/USD')
        
        assert btc_trade['action'] == 'BUY'
    ...
    def test_dashboard_with_real_data(self, temp_env):
        ...
        trades = [
            {"action": "buy", "symbol": "BTC/USD", "price": 50000, "amount": 1,
             "timestamp": "2025-01-01T10:00:00", "reason": "Test", "value": 50000},
            {"action": "sell", "symbol": "BTC/USD", "price": 52000, "amount": 1,
             "timestamp": "2025-01-01T11:00:00", "reason": "Test", "value": 52000},
        ]
