...
class TestPortfolioData:
    ...
    def test_portfolio_balance_exists(self):
...
class TestHoldingsData:
    ...
    def test_holdings_market_value(self):
    ...
    def test_holdings_unrealized_pnl(self):
    ...
    def test_position_details_table_complete(self):
...
class TestSystemStatus:
    ...
    def test_system_status_data_exists(self):
...
class TestRecentSignals:
    ...
    def test_signal_has_all_columns(self):
    ...
    def test_signal_executed_status(self):
...
class TestRecentTrades:
    ...
    def test_trade_has_all_columns(self):
    ...
    def test_trade_has_signal_link(self):
...
class TestTradeHoldingIntegrity:
    ...
    def test_buy_trade_creates_holding(self):
    ...
    def test_holding_has_entry_trade_link(self):
...
class TestFeedsPage:
    ...
    def test_feed_has_all_columns(self):
    ...
    def test_feed_error_status_correct(self):
...
class TestUIDataCompleteness:
    ...
    def test_all_ui_data_present(self):
